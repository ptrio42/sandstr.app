...
| key-25 | Apps → dowolny kafelek aplikacji | — | dead | Sześć `motion.button` (Nostr Bazaar, Chess, Photostr, Lorestr, Zap Poll, Sat Map) **bez `onClick`** — nic się nie uruchamia, nie ma hosta mini-appa. Cała zakładka jest plakatem | `screens/MiniAppsScreen.tsx:5-48,69-81` | breaks-showme | L |

...
> (ekran Search, chrome Discover/Shorts ze źródła, tokeny jasnego motywu) ledger ma
> **143 wiersze = 20 luk + 123 `ok`**, kotwice 26 → 74 → 158 → **164**. `unreachable`
...
| [Amethyst](gaps/amethyst.md) | ready | 20 | 6 | 3 | 11 | 0 | 0 | 123 | 164 | ✅ |
...
| **Razem** | | **508** | **142** | **206** | **94** | **35** | **31** | **228** | **358** | **8/10** |

...
export const capabilities: Record<string, ClientCapabilities> = {
  ...
  primal: {
    ...
    'emoji-reactions': {
      verdict: 'unknown',
      detail:
        'The cited answer covers the heart and its colour only — whether other emoji can be sent was not verified.',
      source: 'like',
    },
    'builtin-wallet': {
      verdict: 'partial',
  ...
  snort: {
    ...
    'emoji-reactions': {
      verdict: 'unknown',
      detail:
        'The cited answer covers the heart only — whether another emoji can be sent was not verified.',
      source: 'react-heart',
    },
    'builtin-wallet': {
      verdict: 'unknown',
      detail:
        'The cited answer documents connecting a wallet in Settings; whether Snort ships one of its own was not verified.',
      source: 'connect-wallet',
    },
    'clear-cache': {
      verdict: 'yes',
  ...
  coracle: {
    ...
    'builtin-wallet': {
      verdict: 'unknown',
      detail:
        'There is a "Your Wallet" page, and zapping a profile does not require it. Whether Coracle ships a wallet of its own was not verified.',
      source: 'connect-wallet',
    },
    'clear-cache': {
      verdict: 'unknown',
      detail:
        'The Database page exports and imports the local database; the cited answer documents no clear control.',
      source: 'clear-cache',
    },
  },
};

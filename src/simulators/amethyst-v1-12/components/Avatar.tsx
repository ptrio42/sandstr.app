...
interface AvatarProps {
  seed: string;
  /** Tailwind size/shape classes for the container, e.g. "w-10 h-10". */
  className?: string;
}

// CSP-safe, offline, deterministic robohash-style robot avatar (Amethyst generates
// robohash robots locally too). Pure inline SVG — no network, unlike DiceBear.
export function Avatar({ seed, className = 'w-10 h-10' }: AvatarProps) {

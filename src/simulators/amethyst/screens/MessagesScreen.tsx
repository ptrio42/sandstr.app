...
const conversations: Convo[] = [
  ...
  { id: 'karrot', name: 'Maple Dev', handle: '@mapledev', verified: true, time: '3h', preview: 'They usually go after hosts, but in amethyst…', unread: true },
  ...
  { id: 'mvl', name: 'Mia Macro', handle: '@macromia', time: '3d', preview: "Let me know when it's a good time for…", fromYou: true },
];

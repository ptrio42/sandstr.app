...
(Bez liczby w taglinie — publiczna narracja to „6 wiernych reprodukcji + 3 early previews",
...
- **READY (status w `registry.tsx`): Amethyst, Damus, YakiHonne, Primal (web)** (2026-07-28) **+ Snort
  ...
  `kind: 'original'` istnieje nadal, ale jest NIELISTOWANY — patrz sekcja Branding.)
...
- **Druga fala / PREVIEW** (słabsza wierność / bugi): Keychat, Coracle, Gossip.
